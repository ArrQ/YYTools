...
@interface YYNoticeView () <UIScrollViewDelegate>
...
- (void)setContentInScrollView:(UIScrollView *)scrollView
{
    ...
    NSAttributedString *attributedString = [[NSAttributedString alloc] initWithData:[nameString dataUsingEncoding:NSUnicodeStringEncoding] options:@{ NSDocumentTypeDocumentAttribute: NSHTMLTextDocumentType } documentAttributes:nil error:nil];
    ...
    //    label.text = nameString;
    NSAttributedString *attributedStringOne = [[NSAttributedString alloc] initWithData:[nameString dataUsingEncoding:NSUnicodeStringEncoding] options:@{ NSDocumentTypeDocumentAttribute: NSHTMLTextDocumentType } documentAttributes:nil error:nil];
    
    label.attributedText = attributedStringOne;
    ...
    NSAttributedString *attributedStringtwo = [[NSAttributedString alloc] initWithData:[nameString dataUsingEncoding:NSUnicodeStringEncoding] options:@{ NSDocumentTypeDocumentAttribute: NSHTMLTextDocumentType } documentAttributes:nil error:nil];
    
    label.attributedText = attributedStringtwo;
