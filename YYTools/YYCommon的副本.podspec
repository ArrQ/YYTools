...
Pod::Spec.new do |s|
    ...
    s.requires_arc = true
    s.source_files = 'YYTools/YYTools/YYCommon/YYTools.h'
    s.subspec 'Tool' do |ss|
        ss.ios.deployment_target = '8.0'
        ss.source_files = 'YYTools/YYTools/YYCommon/YYNoticeViewTool/YYNoticeViewTool.h','YYTools/YYTools/YYCommon/YYNoticeViewTool/**/**.{h,m}'
    end
